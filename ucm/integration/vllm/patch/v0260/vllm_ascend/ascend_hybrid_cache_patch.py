"""Fix hybrid prefix-cache accounting in vLLM-Ascend 0.26.0."""
...
def patch_ascend_single_type_kv_cache_manager(mod):
    ...
    from ucm.integration.vllm.patch.v0260.vllm_ascend.core import (
...
def patch_ascend_kv_cache_coordinator(mod):
    ...
    from ucm.integration.vllm.patch.v0260.vllm_ascend.patch.platform import (
